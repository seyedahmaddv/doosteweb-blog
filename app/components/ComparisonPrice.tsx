...
export default function ComparisonPrice() {
                              ...
                              {section.features.map((feature) => (
                                ...
                                >
                                  ...
                                  <dd className="flex items-center justify-end sm:justify-center sm:px-4">
                                    {typeof feature.tiers[tier.name as 'Starter' | 'Scale' | 'Growth'] === 'string' ? (
                                      <span
                                        className={tier.featured ? 'font-semibold text-indigo-600' : 'text-gray-900'}
                                      >
                                        {feature.tiers[tier.name as 'Starter' | 'Scale' | 'Growth']}
                                      </span>
                                    ) : (
                                      <>
                                        {feature.tiers[tier.name as 'Starter' | 'Scale' | 'Growth'] === true ? (
                                        ...
                                        <span className="sr-only">
                                          {feature.tiers[tier.name as 'Starter' | 'Scale' | 'Growth'] === true ? 'Yes' : 'No'}
                                        </span>
                                      </>
                                    )}
                                  </dd>
